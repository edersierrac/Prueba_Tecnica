      ...
      <form form method="post" action="insertar_receppro.php">
       <div class="form-group  row">
           ...
           <input type="datetime" class="form-control" id="fecha" name="fecha" value="<?= $fecha_actual ?>"  >
                 ...
                 <div class="col-sm-8 ">
                 <input type="text" class="form-control" id="prod" name="prod" placeholder="Producto" required>
                 </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                 <input type="text" class="form-control" id="proov" name="proov" placeholder="Proveedor" required>
                 </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                 <input type="number" class="form-control" id="idpro" name="idpro" placeholder="ID proveedor" required>
                 </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                 <input type="number" class="form-control" id="nunf" name="nunf" placeholder="Numero de factura" required>
                 </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                 <input type="number" class="form-control" id="cant" name="cant" placeholder="Cantidad" required>
                 </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                 <input type="text" class="form-control" id="lot" name="lot" placeholder="Lote" required>
                 </div>
                 </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                 <input type="text" class="form-control" id="regivi" name="regivi" placeholder="Registro INVIMA" required>
                 </div>
                 </div>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                 <input type="date" class="form-control" id="fechav" name="fechav" placeholder="Fecha de vencimiento" required>
                 </div>
               </div>
